...
├─────────────────────────────────────────────────────────┤
│                                                         │
│  ┌─ 1. Video Seçimi ─────┐  ┌─ 2. Çıktı Dizini ──────┐ │
│  │  📂 video.mp4         │  │  📂 /Desktop/frames    │ │
│  │  📊 Video Analizi     │  │  💡 Otomatik oluşturma │ │
│  │  1920x1080 | 60 FPS   │  │                        │ │
│  └───────────────────────┘  └────────────────────────┘ │
│                                                         │
│  ┌─ 3. Ayırma Seçenekleri ──────────────────────────┐  │
│  │  ○ 🎬 Tüm frameleri    ○ 🎭 Sahne değişimi       │  │
│  │  ● ⏰ Zaman aralığı                               │  │
│  │     00:01:30 ────●────●──── 00:02:45             │  │
│  └──────────────────────────────────────────────────┘  │
│                                                         │
│  ┌─ 4. Durum ───────────────────────────────────────┐  │
│  │  İşleniyor... Frame 150/300            ████░ 50% │  │
│  └──────────────────────────────────────────────────┘  │
│                                                         │
│  [ 🚀 İşlemi Başlat ]   [ ❌ İptal Et ]                │
│                                                         │
└─────────────────────────────────────────────────────────┘
```
